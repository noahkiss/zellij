...
#[derive(Clone, PartialEq, ::prost::Oneof)]
    pub enum ActionType {
        ...
        /// retired: the `query-tab-names` CLI verb is gone (list-tabs answers it, and answers more).
        /// The tag stays assigned and the message stays defined - a client of an older build still
        /// sends it, and the wire contract is append-only
        ...
        BreakPanesToNewTab(super::BreakPanesToNewTabAction),
        #[prost(message, tag="162")]
        BreakPanesToTabWithId(super::BreakPanesToTabWithIdAction),
        #[prost(message, tag="163")]
        SetPaneFullscreen(super::SetPaneFullscreenAction),
        #[prost(message, tag="164")]
        SetPanePinned(super::SetPanePinnedAction),
        #[prost(message, tag="165")]
        SetPaneFloating(super::SetPaneFloatingAction),
        #[prost(message, tag="166")]
        SetSyncTab(super::SetSyncTabAction),
        ...
        NewShellPane(super::NewShellPaneAction),
    }
}
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct ResolvePaneTargetAction {
    #[prost(string, tag="1")]
...
/// fork addition: a pane with no command, opened in a cwd the caller named. The four New*Pane
/// actions carry their cwd inside RunCommandAction, so a command-less pane had nowhere to put one.
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct NewShellPaneAction {
    #[prost(message, optional, tag="1")]
    pub placement: ::core::option::Option<NewPanePlacement>,
    #[prost(string, optional, tag="2")]
    pub pane_name: ::core::option::Option<::prost::alloc::string::String>,
...
pub struct CliAssets {
    ...
    /// fork: the terminal device this client is attached to, when it has one. Tag 100 is
    /// fork-reserved, far from the next number upstream would take
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct BreakPanesToNewTabAction {
    #[prost(message, repeated, tag="1")]
    pub pane_ids: ::prost::alloc::vec::Vec<PaneId>,
    #[prost(string, optional, tag="2")]
    pub name: ::core::option::Option<::prost::alloc::string::String>,
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct BreakPanesToTabWithIdAction {
    #[prost(message, repeated, tag="1")]
    pub pane_ids: ::prost::alloc::vec::Vec<PaneId>,
    #[prost(uint32, tag="2")]
    pub tab_id: u32,
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct SetPaneFullscreenAction {
    #[prost(message, optional, tag="1")]
    pub pane_id: ::core::option::Option<PaneId>,
    #[prost(bool, tag="2")]
    pub fullscreen: bool,
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct SetPanePinnedAction {
    #[prost(message, optional, tag="1")]
    pub pane_id: ::core::option::Option<PaneId>,
    #[prost(bool, tag="2")]
    pub pinned: bool,
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct SetPaneFloatingAction {
    #[prost(message, optional, tag="1")]
    pub pane_id: ::core::option::Option<PaneId>,
    #[prost(bool, tag="2")]
    pub floating: bool,
